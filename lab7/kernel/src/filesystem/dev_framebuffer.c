...
//struct file_operations dev_framebuffer_operations = {dev_framebuffer_write, (void *)op_deny, dev_framebuffer_open, dev_framebuffer_close, dev_framebuffer_lseek64, (void *)dev_framebuffer_op_deny};
