...
typedef struct thread
{
    ...
    char*            stack_alloced_ptr;                   // Process Stack (Process itself), user stack
    char*            kernel_stack_alloced_ptr;            // Process Stack (Kernel syscall) kernel stack
    ...
    int              signal_running;                    // Signal Processing Lock
